...
class HardModeController4 extends GetxController {
  ...
  HardModeController4({required List<CameraDescription> cameras}) {
    _cameras = cameras;
  }
  ...
  void _finishStage() {
    ...
    if (_correctExpressions.value > 0) {
      Get.off(() => StageClear4(result: result), arguments: result);
    } else {
      Get.off(() => StageFail4(result: result), arguments: result);
    }
  }
